...
def get_embedding(self, message: str) -> "torch.FloatTensor":
    ...
    """
    encoded_input = self.relevence_tokenizer(
        message,
        padding=True,
        truncation=True,
...
def is_relevant(self, prompt:str, completion: str, is_answer: bool) -> bool:
    ...
    completion_embedding = np.array(self.get_embedding(completion ).tolist())
    prompt_embedding = np.array(self.get_embedding(prompt ).tolist())
